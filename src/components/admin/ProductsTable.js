    ...
    <div className="admin-product">
        ...
        <div className='product-panel'>
            ...
            <div className='divider'>
                ...
                { product && (<button className='second-button' onClick={() => removeProduct(product?.productID)}>DELETE</button>)}{ product?.productID && (<button onClick={() => updateExistingProduct({ productId: product?.productID, product: localProduct })}>SAVE CHANGES</button>)}
<button onClick={() => createProduct({ ...localProduct, productID: 0 })}>Add Product</button>
